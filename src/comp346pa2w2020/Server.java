...
public class Server extends Thread {
    ...
    public void initializeAccounts() {
        ...
        try {
            inputStream = new Scanner(new FileInputStream("./files/account.txt"));
...
//                }
    ...
    public synchronized double withdraw(int i, double amount) {
        double curBalance;      /* Current account balance */
            ...
            System.out.println("\n DEBUG : Server.withdraw - " + "i " + i + " Current balance " + curBalance + " Amount " + amount + " Tread " + getServerThreadId());
    ...
    public synchronized double query(int i) {
        ...
        double curBalance=0;      /* Current account balance */
            curBalance = account[i].getBalance();          /* Get current account balance */
    ...
    public void run() {
        ...
        long serverStartTime1=0, serverEndTime1=0,serverStartTime2=0,serverEndTime2=0;
