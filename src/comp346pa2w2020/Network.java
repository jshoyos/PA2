...
public class Network extends Thread {
    ...
    private static String inBufferStatus, outBufferStatus;     /* Current status of the network buffers - normal, inComingFull, inComingMutex */
    ...
    {
        int i;
        inComingEmpty = new Semaphore(10);
        outGoingEmpty = new Semaphore(10);
    ...
    public static boolean send(Transactions inPacket)
    {
        ...
        /* Check if input buffer is inComingFull */
        if (getinputIndexClient() == getoutputIndexServer())
        {

            setInBufferStatus("inComingFull");
    ...
    public static boolean transferOut(Transactions outPacket)
    {
        ...
        /* Check if output buffer is inComingFull */
        if ( getinputIndexServer( ) == getoutputIndexClient( ))
        {
            try{
                setOutBufferStatus("inComingFull");
            }catch (Exception e){
                System.out.println(e.getMessage());
            }
